...
public class Registration extends AppCompatActivity implements View.OnClickListener {
    ...
    Pattern vname = Pattern.compile("([A-Za-z]*(\\s))+([A-Za-z]*(\\s))+[A-Za-z]+");
    Pattern vnumber = Pattern.compile("[0-9]{11}");
    ...
    Pattern em_name = Pattern.compile("([A-Za-z]*(\\s))+([A-Za-z]*(\\s))+[A-Za-z]+");
    Pattern em_number = Pattern.compile("[0-9]{11}");
